...
QT_MOC_LITERAL(3, 17, 6), // "output"
QT_MOC_LITERAL(4, 24, 6), // "readIt"
QT_MOC_LITERAL(5, 31, 3), // "boo"
QT_MOC_LITERAL(6, 35, 6), // "booboo"
QT_MOC_LITERAL(7, 42, 22), // "QProcess::ProcessError"
QT_MOC_LITERAL(8, 65, 1) // "x"

    },
    "Console\0newData\0\0output\0readIt\0boo\0"
    "booboo\0QProcess::ProcessError\0x"
};
...
void Console::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->readIt(); break;
        case 2: _t->boo(); break;
        case 3: _t->booboo((*reinterpret_cast< QProcess::ProcessError(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Console::newData)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Console::newData(QString _t1)
{
