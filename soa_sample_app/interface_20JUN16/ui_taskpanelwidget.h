...
public:
    ...
    void setupUi(QWidget *TaskPanelWidget)
    {
        ...
        m_pRiskSelect->setGeometry(QRect(150, 110, 221, 41));
        ...
        m_pHSlider->setGeometry(QRect(500, 120, 160, 29));
    ...
    void retranslateUi(QWidget *TaskPanelWidget)
    {
        ...
        m_pSNumLabel_3->setText(QApplication::translate("TaskPanelWidget", "03", 0));
    } // retranslateUi
